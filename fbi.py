...
try:
	...
	print W + ' '
	print ('J O S E P H E S E L P U T O A M O <3').center(44)
	print ' '
...
def baliho():
	try:
		...
		print 'ooO--(_)--Ooo'.center(44)
		print ' ' + W
		print ('JOSEPH FBI TOOL').center(44)
...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     Joseph German - Private Version
    Name       Facebook Information
    Version    Developing...
    Date       08/04/2019 
    Facebook:  Johan Cazares

* si tienes problemas porfavor contactame.
'''%(G,W)
def info_ga():
